package com.manage_system.test;
...
//        headImage2 = (ImageView) findViewById(R.id.head_image2);
        LinearLayout qqLayout = (LinearLayout) findViewById(R.id.qqLayout);
...
//                break;
    ...
    private void uploadHeadImage() {
        ...
        View parent = LayoutInflater.from(this).inflate(R.layout.activity_main1, null);
        ...
        btnCarema.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(MainActivity1.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                    ...
                    ActivityCompat.requestPermissions(MainActivity1.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
        ...
        btnPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //权限判断
                if (ContextCompat.checkSelfPermission(MainActivity1.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED) {
                    //申请READ_EXTERNAL_STORAGE权限
                    ActivityCompat.requestPermissions(MainActivity1.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},
...
//            Uri contentUri = FileProvider.getUriForFile(MainActivity1.this, BuildConfig.APPLICATION_ID + ".fileProvider", tempFile);
            Uri contentUri = FileProvider.getUriForFile(MainActivity1.this,  "com.manage_system.fileProvider", tempFile);
