...
public class TeacherGtCommentLookActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ms_tm_gt_review_item);
        ...
        scoreAnalysis.setText(object.getJSONObject("guidanceTeaGroup").getString("scoreAnalysis"));
        scoreTechnology.setText(object.getJSONObject("guidanceTeaGroup").getString("scoreTechnology"));
        scoreInstruction.setText(object.getJSONObject("guidanceTeaGroup").getString("scoreInstruction"));
        scoreInnovate.setText(object.getJSONObject("guidanceTeaGroup").getString("scoreInnovate"));
        scoreInvestigation.setText(object.getJSONObject("guidanceTeaGroup").getString("scoreInvestigation"));
        scoreWorkload.setText(object.getJSONObject("guidanceTeaGroup").getString("scoreWorkload"));
        scoreTotal.setText(object.getJSONObject("guidanceTeaGroup").getString("scoreTotal"));
        comment.setText(object.getJSONObject("guidanceTeaGroup").getString("comment"));
        reviewDate.setText(DateUtil.getDateFormat(object.getJSONObject("guidanceTeaGroup").getString("reviewDate")));
    ...
    public static Intent createIntent(Context context) {
        return new Intent(context, TeacherGtCommentLookActivity.class);
    }
    ...
    public void downLoad(String title,String message,final String fileId){
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //配置progressDialog
                final ProgressDialog dialog= new ProgressDialog(TeacherGtCommentLookActivity.this);
            ...
            public void onDownloadSuccess() {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(TeacherGtCommentLookActivity.this, "下载成功", Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
            ...
            public void onDownloadFailed() {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(TeacherGtCommentLookActivity.this, "下载失败", Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
                });
            }
